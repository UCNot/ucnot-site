...
URI Charge Notation is a text format designed to encode arbitrary JavaScript values as part of URI. The URI containing
data encoded this way is called [Charge URI], or just URI.

URI Charge Notation is also usable as message body encoding. In this case it has fewer limitations. E.g. it may contain
symbols not acceptable within URI. Spaces, tabs and new line symbols may be used to organize the message for better
readability.
